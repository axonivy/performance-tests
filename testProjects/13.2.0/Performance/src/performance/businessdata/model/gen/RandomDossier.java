...
import performance.businessdata.model.AccountHolder;
import performance.businessdata.model.AccountHolder.AhType;
import performance.businessdata.model.BeneficialOwner;
import performance.businessdata.model.ControllingPerson;
import performance.businessdata.model.ControllingPersonManagement;
import performance.businessdata.model.Dossier;
import performance.businessdata.model.Legitimate;
import performance.businessdata.model.LegitimateManagement;
import performance.businessdata.model.Person;
...
public class RandomDossier {
  ...
  private static LegitimateManagement legitimateMgmt(Dossier dossier) {
    ...
    mgmt.onlyLegitimatesAreBO = randomBoolean();
  ...
  private static ControllingPersonManagement controllingMgmt(Dossier dossier) {
    ...
    mgmt.fiduciaryHoldingAssets = randomBoolean();
  ...
  private static AccountHolder createAccountHolder() {
    ...
    holder.correspondence = Correspondences.createRandom();
    holder.registered = randomBoolean();
    return holder;
  }
